...
//! - VMAC from draft-krovetz-vmac-01: [`Vmac64`] and [`Vmac128`], AES-128
//!   by default (any 128-bit block cipher via `with_cipher`), with a nonce
//!   of at most 127 bits (a longer one is an [`InvalidNonce`] error).
