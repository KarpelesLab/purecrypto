...
pub mod oid {
    ...
    /// `id-X25519` (1.3.101.110) — X25519 key-agreement key (RFC 8410).
    pub const ID_X25519: &[u64] = &[1, 3, 101, 110];
    /// `id-X448` (1.3.101.111) — X448 key-agreement key (RFC 8410).
    pub const ID_X448: &[u64] = &[1, 3, 101, 111];
