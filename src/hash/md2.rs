...
//! the digits of π. As with the other table-based hashes here, the lookups are
//! not constant time: they are indexed by the state, so with an unkeyed digest
//! they leak only the (public) message bytes.
//!
