...
// The entry shim generated by `fullrust::entry!` is an undocumented public
// symbol; relax `missing_docs` for this crate on the freestanding target only.
#![cfg_attr(target_vendor = "fullrust", allow(missing_docs))]
